...
// ---**  --***
// ---**
#define BLOCK_5_HEIGHT 3
#define BLOCK_5_WIDTH 2
static rowtype block_5_vert[] = { 0b11, 0b11, 0b11};
static rowtype block_5_horz[] = { 0b111,0b111 };	
...
static rowtype block_6_vert[] = { 0b011, 0b110};
static rowtype block_6_horz[] = { 0b10, 0b11,0b01 };
...
static const BlockInfo block_library[NUM_BLOCKS_IN_LIBRARY] = {
	...
	{ //Block 5
		...
		{block_5_vert, block_5_horz, block_5_vert, block_5_horz}
	}, 
	{//Block 6
		COLOUR_LIGHT_YELLOW, BLOCK_6_HEIGHT, BLOCK_6_WIDTH,
		{block_6_vert, block_6_horz, block_6_vert, block_6_horz}
	}
